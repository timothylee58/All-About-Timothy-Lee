...
## About Me
I built full-stack, AI-powered applications — and I bring operational context that most developers don't have.
...
Some things I've built: an automated Slack bot for multi-country weather and traffic alerts (Node.js, Express, Axios, node-cron, Slack API, deployed on Render), and a video steganography system for covert applications with AES-256-GCM encryption and async processing (FastAPI, Celery, Redis, OpenCV) — validated at 99.9% data integrity across resolutions up to 1440p. 
